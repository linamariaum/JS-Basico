const menjase = 'El número en romano es: ';
const separador = ',';
const bisiesto = document.querySelector("button");
bisiesto.addEventListener("click", numEnRomano);

function numEnRomano() {
    const texto = document.getElementById("textNum").value;
    ...
    document.getElementById("resultNumEnRomano").innerHTML = menjase + res.join('');
}